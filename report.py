...
from mitmproxy.config import url_category

ROOM = Namespace("http://projects.bigasterisk.com/room/")
DCTERMS = Namespace("http://purl.org/dc/terms/")


class Boring(ValueError):
    pass
...
def quadsForEvent(doc):
    ...
    ret = [
        ...
        (uri, ROOM['killed'], Literal(doc.get('killed', 'missing-killed')), ctx),
    ]
    ...
    if tag == 'youtube':
        ...
        if 'watchtime' in doc:
            ...
            ret.extend([
                ...
                (uri, ROOM['videoThumbnailUrl'], URIRef(f'https://img.youtube.com/vi/{vid}/default.jpg'), ctx),
            ])
    elif tag == 'slackChat':
...
def main():
    ...
    coll = MongoClient('mongodb', tz_aware=True).get_database('timebank').get_collection('webproxy')
    ...
    class Application(cyclone.web.Application):
        ...
        def __init__(self):
            ...
            cyclone.web.Application.__init__(self, handlers, masterGraph=masterGraph, coll=coll)
